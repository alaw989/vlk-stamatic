        ...
        <div class="content-container w-full">
            <div class="w-full flex justify-center">
                <div class="flex justify-center flex-col items-center text-center w-full max-w-[75%]">
                    <h1 v-html="home.paragraph_section_2?.heading" class="text-2xl md:text-4xl text-white font-bold mb-4 lg:mb-6"></h1>
                    <p class="text-white text-center max-w-[800px] m-0" v-html="home.paragraph_section_2?.body"></p>
                    <router-link :to="home.paragraph_section_2?.link_url" v-if="home.paragraph_section_2?.link_url" class=" mt-4 lg:mt-6 hover:no-underline">
