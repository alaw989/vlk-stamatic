    ...
    <div v-if="home" class="w-full flex justify-center">
        <div class="w-full max-w-[75%]">
            <div class="flex justify-center flex-col items-center relative">
                <h1 class="text-2xl md:text-4xl text-black font-bold text-center mb-4 lg:mb-6 text-white">What We Do</h1>
                <div class="w-full">
                    <ul class="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mb-0">
